...
class FileKVTest {
    ...
    private static Path filepath = Paths.get("src/test/resources/file1").toAbsolutePath().normalize();
    ...
    void fileKVTest() throws IOException {
        KeyValueStorage storage = new FileKV("src/test/resources/file1", Map.of("key", "10"));
    ...
    void mustBeImmutableTest() throws IOException {
        ...
        KeyValueStorage storage = new FileKV("src/test/resources/file1", initial);
